    ...
    <Container>
      ...
      <Alert variant="info" className="mt-3">
        ...
        <ol>
          <li>
            Go to{" "}
            <Link href={"https://cyclonedx.org/tool-center/"}>
              CycloneDX Tool Center
            </Link>{" "}
            and find a tool to generate SBOM according to your programming
            language
          </li>
          <li>
            Create the SBOM file according to the documentation for a given tool
            - Choose XML as output file.
          </li>
